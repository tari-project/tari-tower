...
class OrbitControls extends EventDispatcher {
	constructor(object, domElement) {
		...
		if (domElement === undefined) logWarn('THREE.OrbitControls: The second parameter "domElement" is now mandatory.');
		if (domElement === document) logError('THREE.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.');
		...
		const pan = (function () {
			...
			return function pan(deltaX, deltaY) {
				...
				if (scope.object.isPerspectiveCamera) {
					...
					logWarn('WARNING: OrbitControls.js encountered an unknown camera type - pan disabled.');
		...
		function dollyOut(dollyScale) {
			if (scope.object.isPerspectiveCamera) {
				...
				logWarn('WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled.');
